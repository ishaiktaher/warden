...
_OAUTH_NAMES = (
    "Acuity Scheduling", "Adobe", "Aircall", "Airtable", "Apollo.io", "Asana",
    "Atlassian", "Attio", "Autodesk", "Basecamp", "Bitbucket", "Bitly", "Box",
    "Brex", "Cal.com", "Calendly", "Canva", "ClickUp", "Close",
    "Constant Contact", "Contentful", "Deel", "Dialpad", "DigitalOcean", "Discord",
    "DocuSign", "Dropbox", "eBay", "Eventbrite", "Facebook", "Figma", "GitHub",
    "Google", "HubSpot", "Instagram", "Linear", "LinkedIn", "Mailchimp", "Mercury",
    "Microsoft", "Miro", "monday.com", "Notion", "Outreach", "PagerDuty", "PayPal",
    "Pinterest", "Pipedrive", "QuickBooks", "Ramp", "Reddit", "RingCentral",
    "Salesforce", "Sentry", "Slack", "Snapchat", "Spotify", "Square", "Squarespace",
    "Stripe", "TikTok", "Todoist", "Twitter (X)", "Typeform", "Webex", "Webflow",
)

_MANAGED_NAMES = (
    "Airtable", "Algolia", "AWS", "Axiom", "Braze", "Brevo", "Browserbase", "Clerk",
...
def catalog(*, kind: str | None = None, query: str | None = None) -> list[dict]:
    ...
    return [
        item.public() for item in INTEGRATIONS
        if (not kind or item.kind == kind)
        and (not normalized_query or normalized_query in item.name.lower()
